...
from bot.texts import STATS_BTN, CREATE_PROMO_BTN, BAN_USER_BTN, BACK_TO_MAIN_MENU_BTN, OK_BTN, BACK_BTN, MASS_MAIL_BTN, \
    ADD_ADMIN_BTN, CHANGE_PRICE_BTN, UPLOAD_USERS_BTN, FIND_USER_BTN, CHANGE_VIDEO_PRICE_BTN, CHANGE_IMAGE_PRICE_BTN
...
admin_keyboard = types.InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        # [types.InlineKeyboardButton(text=CHANGE_VIDEO_PRICE_BTN, callback_data="video_change_prices")],
        [types.InlineKeyboardButton(text=CHANGE_IMAGE_PRICE_BTN, callback_data="image_change_prices")],
