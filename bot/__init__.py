...
from bot.utils.config import OPENAI_API_KEY, OPENAI_MODEL, QWEN_API_KEY, QWEN_MODEL, CKASSA_BASE_URL, \
    CKASSA_SHOP_TOKEN, CKASSA_SEC_KEY, CKASSA_SERVICE_CODE, CKASSA_WEBHOOKS_URL
...
ckassa = CKassa(CKASSA_BASE_URL, CKASSA_SHOP_TOKEN, CKASSA_SEC_KEY, CKASSA_SERVICE_CODE, CKASSA_WEBHOOKS_URL)
